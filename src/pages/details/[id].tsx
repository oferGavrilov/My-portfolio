    ...
    <>
      ...
      <section className='bg-[#141414] pt-24 px-10 md:px-20 lg:px-32'>
        ...
        <div className='py-10'>
          ...
          <p className='pb-14 custom-paragraph'>The {project.title} application is designed responsively for all device sizes.</p>
          <div className='flex flex-col lg:flex-row justify-center md:justify-evenly items-center gap-24'>
            <img className='mockup-img bounce' src={project.mockupDesktop} alt={`${project.title} - Desktop Mockup`} />
            <img className='mockup-img bounce' src={project.mockupLaptop} alt={`${project.title} - Laptop Mockup`} />
            <img className='mockup-img !w-[130px] md:!w-[180px] bounce' src={project.mockupMobile} alt={`${project.title} - Mobile Mockup`} />
          </div>
        </div>
